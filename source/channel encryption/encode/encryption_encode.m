% source/channel encryption/encode/encryption_encode.m
%
...
function out_stream = encryption_encode(encryption_name, key, stream, option)
    % INPUT:
    ...
    switch encryption_name
        case 'OTP'
            out_stream = encode_OTP(key, stream, option);
        otherwise
            fprintf('\n');
